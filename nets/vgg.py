...
class VGG_32x32(nn.Module):
    def __init__(
        self, vgg_name, channel, num_classes, record_embedding=False, no_grad=False
    ):
...
def VGG(
    ...
    if pretrained:
        ...
        net = VGG_224x224(
            features=vgg.make_layers(cfg_vgg[arch], True),
            channel=3,
            num_classes=1000,
...
def VGG11(
    ...
    return VGG(
        "vgg11", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def VGG13(
    ...
    return VGG(
        "vgg13", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def VGG16(
    ...
    return VGG(
        "vgg16", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def VGG19(
    ...
    return VGG(
        "vgg19", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
