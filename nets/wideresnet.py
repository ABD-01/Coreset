...
def WRN168(
    ...
    return WideResNet(
        "wrn168", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def WRN2810(
    ...
    return WideResNet(
        "wrn2810", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def WRN282(
    ...
    return WideResNet(
        "wrn282", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def WRN502(
    ...
    return WideResNet(
        "wrn502", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
...
def WRN1012(
    ...
    return WideResNet(
        "wrn1012", channel, num_classes, im_size, record_embedding, no_grad, pretrained
    )
